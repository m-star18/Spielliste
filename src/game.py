...
class GameData:
    ...
    def add_menu(self):
        ...
        layout_add = [
            ...
            [sg.FileBrowse(button_text='romファイルを選択してください', size=GAME_MENU_BROWSE_SIZE, font=FONT_SIZE, key=SITE_DATA_NUMBER),
             ],
            [sg.FileBrowse(button_text='実行ファイルを選択してください', size=GAME_MENU_BROWSE_SIZE, font=FONT_SIZE, key=EXEC_DATA_NUMBER),
             ],
