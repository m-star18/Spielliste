...
def main(game_list_data=None, event_data='', number_data=0, input_text='', values_data=None):
    if game_list_data is None:
        game_list_data, event_data = open_file()
    ...
    window = main_menu(game_list_data, number_data, input_text, values_data)
    ...
    while True:
        ...
        event_data = event_check(event, values, values_data, game_list_data, number_data, event_data, window)
